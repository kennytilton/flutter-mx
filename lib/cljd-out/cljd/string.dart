...
import "string.dart" as Ukdmcmlcoc_string;
...
return (Ukdmcmlcoc_core.$EQ_.$_invoke$2("", Ukdmcmlcoc_string.trim((s$1 as dc.String?), ), ));
}
...
cast$1=(((Ukdmcmlcoc_core.ICounted.extensions(coll7285$1, ) as Ukdmcmlcoc_core.ICounted$ext).$_count$0(coll7285$1, )) as dc.int);
}
final dc.bool $1=(cast$1<2);
if($1){
return ((s$1 as dc.String).toUpperCase());
}
return (Ukdmcmlcoc_core.str.$_invoke$2((Ukdmcmlcoc_core.subs.$_invoke$3((s$1 as dc.String), 0, 1, ).toUpperCase()), (Ukdmcmlcoc_core.subs.$_invoke$2((s$1 as dc.String), 1, ).toLowerCase()), ));
}
...
}else if((cmap$1 is Ukdmcmlcoc_core.IFn$iface)){
temp$7105_$AUTO_$1=((cmap$1 as Ukdmcmlcoc_core.IFn$iface).$_invoke$1(p2$8741_$SHARP_$1, ));
}else{
temp$7105_$AUTO_$1=(Ukdmcmlcoc_core.IFn.extensions(cmap$1, ).$_invoke$1(cmap$1, p2$8741_$SHARP_$1, ));
}
late final dc.dynamic $if_$1;
if(((temp$7105_$AUTO_$1!=false)&&(temp$7105_$AUTO_$1!=null))){
final dc.dynamic replacement$1=temp$7105_$AUTO_$1;
$if_$1=(Ukdmcmlcoc_core.str.$_invoke$1(replacement$1, ));
}else{
...
// BEGIN index-of
Ukdmcmlcoc_core.IFn$iface index_of=Ukdmcmlcoc_string.index_of$ifn(null, );

// END index-of

// BEGIN index_of$ifn
class index_of$ifn extends dc.Object with Ukdmcmlcoc_core.IFnMixin_uuXX implements Ukdmcmlcoc_core.IMeta$iface, Ukdmcmlcoc_core.IWithMeta$iface, Ukdmcmlcoc_core.Fn$iface, Ukdmcmlcoc_core.IFn$iface {
final meta$1;
...
return Ukdmcmlcoc_string.index_of$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}
...
// BEGIN join
Ukdmcmlcoc_core.IFn$iface join=Ukdmcmlcoc_string.join$ifn(null, );

// END join

// BEGIN join$ifn
class join$ifn extends dc.Object with Ukdmcmlcoc_core.IFnMixin_uXX implements Ukdmcmlcoc_core.IMeta$iface, Ukdmcmlcoc_core.IWithMeta$iface, Ukdmcmlcoc_core.Fn$iface, Ukdmcmlcoc_core.IFn$iface {
final meta$1;
...
dc.dynamic $_with_meta$1(dc.dynamic m$2054_$AUTO_$1, ){
return Ukdmcmlcoc_string.join$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}

dc.dynamic $_invoke$1(dc.dynamic coll$1, ){
return (Ukdmcmlcoc_core.apply.$_invoke$2(Ukdmcmlcoc_core.str, coll$1, ));
}

dc.dynamic $_invoke$2(dc.dynamic separator$1, dc.dynamic coll$2, ){
return ((Ukdmcmlcoc_core.map.$_invoke$2(Ukdmcmlcoc_core.str, coll$2, ) as dc.Iterable).join((separator$1 as dc.String), ));
}
...
// BEGIN last-index-of
Ukdmcmlcoc_core.IFn$iface last_index_of=Ukdmcmlcoc_string.last_index_of$ifn(null, );

// END last-index-of

// BEGIN last_index_of$ifn
class last_index_of$ifn extends dc.Object with Ukdmcmlcoc_core.IFnMixin_uuXX implements Ukdmcmlcoc_core.IMeta$iface, Ukdmcmlcoc_core.IWithMeta$iface, Ukdmcmlcoc_core.Fn$iface, Ukdmcmlcoc_core.IFn$iface {
final meta$1;
...
dc.dynamic $_with_meta$1(dc.dynamic m$2054_$AUTO_$1, ){
return Ukdmcmlcoc_string.last_index_of$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}
...
return (Ukdmcmlcoc_core.str.$_invoke$2("\\", ((m$1 as dc.Match).group(0, )), ));
}, ));
}
...
final dc.dynamic replacement$2=Ukdmcmlcoc_string.replacer(replacement$1, );
...
if((maybe_f$1 is Ukdmcmlcoc_core.IFn$iface)){
return ((maybe_f$1 as Ukdmcmlcoc_core.IFn$iface).$_invoke$1($1, ));
}
return (Ukdmcmlcoc_core.IFn.extensions(maybe_f$1, ).$_invoke$1(maybe_f$1, $1, ));
};
}
return ((s$1 as dc.String).replaceAllMapped(arg$1, wrapper_f$1, ));
}
throw dc.ArgumentError((Ukdmcmlcoc_core.str.$_invoke$2("Invalid match arg: ", match$1, )), );
}
...
dc.dynamic vs$1=Ukdmcmlcoc_core.$_EMPTY_VECTOR;
dc.dynamic i$1=0;
do {
...
final dc.bool and$7082_$AUTO_$1=(Ukdmcmlcoc_core.$EQ_.$_invoke$2(1, cast$1, ));
late final dc.bool $if_$1;
if(and$7082_$AUTO_$1){
$if_$1=(Ukdmcmlcoc_core.peek(vs$1, ) is dc.String);
}else{
$if_$1=and$7082_$AUTO_$1;
}
if($if_$1){
return Ukdmcmlcoc_core.peek(vs$1, );
}
...
o7251$1=Ukdmcmlcoc_string.re_unquote_replacement(r$1, );
}
if((coll7250$1 is Ukdmcmlcoc_core.ICollection$iface)){
vs$1=((coll7250$1 as Ukdmcmlcoc_core.ICollection$iface).$_conj$1(o7251$1, ));
}else{
vs$1=((Ukdmcmlcoc_core.ICollection.extensions((coll7250$1 as dc.dynamic), ) as Ukdmcmlcoc_core.ICollection$ext).$_conj$1((coll7250$1 as dc.dynamic), o7251$1, ));
}
...
final dc.dynamic arg$1=Ukdmcmlcoc_core.re_groups((m$3 as dc.Match), );
late final dc.dynamic $if_$3;
if((replacement$1 is dc.Function)){
$if_$3=(replacement$1 as dc.Function)(arg$1, );
}else if((replacement$1 is Ukdmcmlcoc_core.IFn$iface)){
$if_$3=((replacement$1 as Ukdmcmlcoc_core.IFn$iface).$_invoke$1(arg$1, ));
}else{
$if_$3=(Ukdmcmlcoc_core.IFn.extensions(replacement$1, ).$_invoke$1(replacement$1, arg$1, ));
}
...
// BEGIN split
Ukdmcmlcoc_core.IFn$iface split=Ukdmcmlcoc_string.split$ifn(null, );

// END split

// BEGIN split$ifn
class split$ifn extends dc.Object with Ukdmcmlcoc_core.IFnMixin_uuXX implements Ukdmcmlcoc_core.IMeta$iface, Ukdmcmlcoc_core.IWithMeta$iface, Ukdmcmlcoc_core.Fn$iface, Ukdmcmlcoc_core.IFn$iface {
final meta$1;
...
dc.dynamic $_with_meta$1(dc.dynamic m$2054_$AUTO_$1, ){
return Ukdmcmlcoc_string.split$ifn((m$2054_$AUTO_$1 as dc.dynamic), );
}

dc.dynamic $_invoke$2(dc.dynamic s$1, dc.dynamic re$1, ){
final dc.String s$2=(s$1 as dc.String);
return Ukdmcmlcoc_core.vec((s$2.split((re$1 as dc.Pattern), )), );
}
...
return (Ukdmcmlcoc_string.split.$_invoke$2(s$4, re$3, ));
}
dc.dynamic v$1=Ukdmcmlcoc_core.transient(Ukdmcmlcoc_core.$_EMPTY_VECTOR, );
dc.dynamic i$1=0;
final dc.dynamic o7205$1=(Ukdmcmlcoc_core.take.$_invoke$2(((limit$1 as dc.num)-1), (re$3.allMatches(s$4, )), ));
dc.dynamic matches$1;
if((o7205$1 is Ukdmcmlcoc_core.ISeqable$iface)){
matches$1=((o7205$1 as Ukdmcmlcoc_core.ISeqable$iface).$_seq$0());
}else{
matches$1=((Ukdmcmlcoc_core.ISeqable.extensions((o7205$1 as dc.dynamic), ) as Ukdmcmlcoc_core.ISeqable$ext).$_seq$0((o7205$1 as dc.dynamic), ));
}
do {
final dc.dynamic temp$7095_$AUTO_$1=matches$1;
if((null==(temp$7095_$AUTO_$1 as dc.dynamic))){
return Ukdmcmlcoc_core.persistent$BANG_((Ukdmcmlcoc_core.conj$BANG_.$_invoke$2(v$1, (Ukdmcmlcoc_core.subs.$_invoke$2(s$4, i$1, )), )), );
}
...
seq$8739_$1=((o7205$2 as Ukdmcmlcoc_core.ISeqable$iface).$_seq$0());
}else{
seq$8739_$1=((Ukdmcmlcoc_core.ISeqable.extensions((o7205$2 as dc.dynamic), ) as Ukdmcmlcoc_core.ISeqable$ext).$_seq$0((o7205$2 as dc.dynamic), ));
}
final dc.dynamic first$8740_$1=Ukdmcmlcoc_core.first(seq$8739_$1, );
final dc.dynamic seq$8739_$2=Ukdmcmlcoc_core.next(seq$8739_$1, );
final dc.Match m$1=(first$8740_$1 as dc.Match);
final dc.dynamic matches$2=seq$8739_$2;
v$1=(Ukdmcmlcoc_core.conj$BANG_.$_invoke$2(v$1, (Ukdmcmlcoc_core.subs.$_invoke$3(s$4, i$1, m$1.start, )), ));
i$1=m$1.end;
matches$1=matches$2;
continue;
} while(true);
...
return (Ukdmcmlcoc_string.split.$_invoke$2(s$1, dc.RegExp("\\r?\\n", ), ));
}
...
final dc.bool or$7123_$AUTO_$1=(Ukdmcmlcoc_core.$EQ_.$_invoke$2(ch$1, "\n", ));
late final dc.bool $if_$1;
if(or$7123_$AUTO_$1){
$if_$1=or$7123_$AUTO_$1;
}else{
$if_$1=(Ukdmcmlcoc_core.$EQ_.$_invoke$2(ch$1, "\r", ));
}
if($if_$1){

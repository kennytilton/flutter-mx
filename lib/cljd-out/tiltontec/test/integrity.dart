...
dc.dynamic iter$9240_$1(dc.dynamic coll$9241_$2, ){
dc.dynamic coll$9241_$1=coll$9241_$2;
do {
if(((coll$9241_$1!=false)&&(coll$9241_$1!=null))){
if(Ukddmlcoc_core.chunked_seq$QMARK_(coll$9241_$1, )){
final dc.dynamic c$7944_$AUTO_$2=Ukddmlcoc_core.chunk_first(coll$9241_$1, );
...
late final dc.dynamic vec$9248_$1;
if((coll7421$2 is Ukddmlcoc_core.IIndexed$iface)){
vec$9248_$1=((coll7421$2 as Ukddmlcoc_core.IIndexed$iface).$_nth$1(n7422$2, ));
}else{
vec$9248_$1=((Ukddmlcoc_core.IIndexed.extensions((coll7421$2 as dc.dynamic), ) as Ukddmlcoc_core.IIndexed$ext).$_nth$1((coll7421$2 as dc.dynamic), n7422$2, ));
}
final dc.dynamic k$3=(Ukddmlcoc_core.nth.$_invoke$3(vec$9248_$1, 0, null, ));
final dc.dynamic v$3=(Ukddmlcoc_core.nth.$_invoke$3(vec$9248_$1, 1, null, ));
...
return iter$9240_$1(Ukddmlcoc_core.chunk_next(coll$9241_$1, ), );
} as dc.dynamic), null, -1, ), );
}
if(((exit$7946_$AUTO_$2!=false)&&(exit$7946_$AUTO_$2!=null))){
return null;
}
coll$9241_$1=Ukddmlcoc_core.chunk_next(coll$9241_$1, );
continue;
}
final dc.dynamic vec$9251_$1=Ukddmlcoc_core.first(coll$9241_$1, );
final dc.dynamic k$4=(Ukddmlcoc_core.nth.$_invoke$3(vec$9251_$1, 0, null, ));
final dc.dynamic v$4=(Ukddmlcoc_core.nth.$_invoke$3(vec$9251_$1, 1, null, ));
...
return iter$9240_$1(Ukddmlcoc_core.next(coll$9241_$1, ), );
} as dc.dynamic), null, -1, ), );
}
return null;
} while(true);
...
final dc.dynamic coll7310$1=Ukddmlcoc_core.deref(obsd$1, );
dc.Null f7311$1(dc.dynamic acc$9254_$1, dc.dynamic p$9255_$1, ){
final dc.dynamic vec$9256_$1=p$9255_$1;
final dc.dynamic k$5=(Ukddmlcoc_core.nth.$_invoke$3(vec$9256_$1, 0, null, ));
final dc.dynamic v$5=(Ukddmlcoc_core.nth.$_invoke$3(vec$9256_$1, 1, null, ));
assert((){
...
final dc.dynamic c$9116_$AUTO_$1=alarm$1;
final dc.dynamic o7473$1=$new_$1;
...
late final dc.dynamic new_value$9117_$AUTO_$1;
switch(hash$1){
case 2635448847:
if((Ukddmlcoc_core.$EQ_.$_invoke$2(const Ukddmlcoc_core.Keyword(null, "home", 2635448847, ), $new_$1, ))){
new_value$9117_$AUTO_$1=const Ukddmlcoc_core.Keyword(null, "off", 3049131293, );
}else{
continue _default;
}
break;
...
new_value$9117_$AUTO_$1=const Ukddmlcoc_core.Keyword(null, "on", 3621113931, );
}else{
continue _default;
}
break;
_default: default:
new_value$9117_$AUTO_$1=(Ukddmlcotu_core.err.$_invoke$1((Ukddmlcoc_core.str.$_invoke$2("unexpected loc ", $new_$1, )), ));
}
return Ukddmlcotc_core.call_c_reset_next$BANG_(c$9116_$AUTO_$1, new_value$9117_$AUTO_$1, );
};
...
final dc.dynamic slot_name$1=Ukddmlcotc_base.c_slot(slot_c$SHARP_$1, );
final dc.dynamic cache$1=Ukddmlcotc_base.c_value(slot_c$SHARP_$1, );
final dc.dynamic test$6952_$AUTO_$1=Ukddmlcotc_evaluate.c_get(act$1, );
final dc.dynamic o7473$2=test$6952_$AUTO_$1;
...
final dc.dynamic test$6952_$AUTO_$2=Ukddmlcotc_evaluate.c_get(act$1, );
final dc.dynamic o7473$3=test$6952_$AUTO_$2;
...
switch(hash$3){
case 1318096193:
if((Ukddmlcoc_core.$EQ_.$_invoke$2(const Ukddmlcoc_core.Keyword(null, "return", 1318096193, ), test$6952_$AUTO_$2, ))){
...
break;
case 1370755019:
if((Ukddmlcoc_core.$EQ_.$_invoke$2(const Ukddmlcoc_core.Keyword(null, "leave", 1370755019, ), test$6952_$AUTO_$2, ))){
...
break;
_default: default:
new_value$9117_$AUTO_$1=(Ukddmlcotu_core.err.$_invoke$1((Ukddmlcoc_core.str.$_invoke$2("unexpected loc %s", $new_$1, )), ));
}
return Ukddmlcotc_core.call_c_reset_next$BANG_(c$9116_$AUTO_$1, new_value$9117_$AUTO_$1, );
};
...
final dc.dynamic slot_name$2=Ukddmlcotc_base.c_slot(slot_c$SHARP_$2, );
final dc.dynamic cache$2=Ukddmlcotc_base.c_value(slot_c$SHARP_$2, );
final dc.num or$7168_$AUTO_$1=(1+(fsia$1() as dc.num));

...
dc.dynamic iter$10516_$1(dc.dynamic coll$10517_$2, ){
dc.dynamic coll$10517_$1=coll$10517_$2;
do {
if(((coll$10517_$1!=false)&&(coll$10517_$1!=null))){
if(Ukddmlcoc_core.chunked_seq$QMARK_(coll$10517_$1, )){
final dc.dynamic c$7899_$AUTO_$2=Ukddmlcoc_core.chunk_first(coll$10517_$1, );
...
late final dc.dynamic vec$10524_$1;
if((coll7376$2 is Ukddmlcoc_core.IIndexed$iface)){
vec$10524_$1=((coll7376$2 as Ukddmlcoc_core.IIndexed$iface).$_nth$1(n7377$2, ));
}else{
vec$10524_$1=((Ukddmlcoc_core.IIndexed.extensions((coll7376$2 as dc.dynamic), ) as Ukddmlcoc_core.IIndexed$ext).$_nth$1((coll7376$2 as dc.dynamic), n7377$2, ));
}
final dc.dynamic k$3=(Ukddmlcoc_core.nth.$_invoke$3(vec$10524_$1, 0, null, ));
final dc.dynamic v$3=(Ukddmlcoc_core.nth.$_invoke$3(vec$10524_$1, 1, null, ));
...
return iter$10516_$1(Ukddmlcoc_core.chunk_next(coll$10517_$1, ), );
} as dc.dynamic), null, -1, ), );
}
if(((exit$7901_$AUTO_$2!=false)&&(exit$7901_$AUTO_$2!=null))){
return null;
}
coll$10517_$1=Ukddmlcoc_core.chunk_next(coll$10517_$1, );
continue;
}
final dc.dynamic vec$10527_$1=Ukddmlcoc_core.first(coll$10517_$1, );
final dc.dynamic k$4=(Ukddmlcoc_core.nth.$_invoke$3(vec$10527_$1, 0, null, ));
final dc.dynamic v$4=(Ukddmlcoc_core.nth.$_invoke$3(vec$10527_$1, 1, null, ));
...
return iter$10516_$1(Ukddmlcoc_core.next(coll$10517_$1, ), );
} as dc.dynamic), null, -1, ), );
}
return null;
} while(true);
...
dc.Null f7266$1(dc.dynamic acc$10530_$1, dc.dynamic p$10531_$1, ){
final dc.dynamic vec$10532_$1=p$10531_$1;
final dc.dynamic k$5=(Ukddmlcoc_core.nth.$_invoke$3(vec$10532_$1, 0, null, ));
final dc.dynamic v$5=(Ukddmlcoc_core.nth.$_invoke$3(vec$10532_$1, 1, null, ));
assert((){
...
final dc.dynamic c$10392_$AUTO_$1=alarm$1;
...
late final dc.dynamic new_value$10393_$AUTO_$1;
switch(hash$1){
case 2635448847:
if((Ukddmlcoc_core.$EQ_.$_invoke$2(const Ukddmlcoc_core.Keyword(null, "home", 2635448847, ), $new_$1, ))){
new_value$10393_$AUTO_$1=const Ukddmlcoc_core.Keyword(null, "off", 3049131293, );
}else{
continue _default;
}
break;
...
new_value$10393_$AUTO_$1=const Ukddmlcoc_core.Keyword(null, "on", 3621113931, );
}else{
continue _default;
}
break;
_default: default:
new_value$10393_$AUTO_$1=(Ukddmlcotu_core.err.$_invoke$1((Ukddmlcoc_core.str.$_invoke$2("unexpected loc ", $new_$1, )), ));
}
return Ukddmlcotc_core.call_c_reset_next$BANG_(c$10392_$AUTO_$1, new_value$10393_$AUTO_$1, );
};
...
break;
_default: default:
new_value$10393_$AUTO_$1=(Ukddmlcotu_core.err.$_invoke$1((Ukddmlcoc_core.str.$_invoke$2("unexpected loc %s", $new_$1, )), ));
}
return Ukddmlcotc_core.call_c_reset_next$BANG_(c$10392_$AUTO_$1, new_value$10393_$AUTO_$1, );
};

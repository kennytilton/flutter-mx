...
assert((){
late final dc.bool $if_$7;
if(Ukddmlcoc_core.every$QMARK_((dc.dynamic p1$10028_$SHARP_$1, ){
return (Ukddmlcoc_core.$EQ_.$_invoke$2(res$1, Ukddmlcotc_base.c_me(p1$10028_$SHARP_$1, ), ));
...
final dc.List<dc.dynamic> fl$19=(dc.List<dc.dynamic>.filled(1, (Ukddmlcoc_core.symbol.$_invoke$2(null, "p1__10028#", )), ));
...
fl$21[1]=(Ukddmlcoc_core.symbol.$_invoke$2(null, "p1__10028#", ));
...
final dc.bool $39=(Ukddmlcoc_core.$EQ_.$_invoke$2($38, Ukddmlcoc_core.$set_((Ukddmlcoc_core.map.$_invoke$2((dc.dynamic p1$10029_$SHARP_$1, ){
return Ukddmlcotc_base.c_slot(p1$10029_$SHARP_$1, );
}, Ukddmlcoc_core.vals(Ukddmlcotm_base.md_cz(res$1, ), ), )), ), ));
late final dc.bool $if_$8;
if($39){
$if_$8=true;
...
final dc.List<dc.dynamic> fl$30=(dc.List<dc.dynamic>.filled(1, (Ukddmlcoc_core.symbol.$_invoke$2(null, "p1__10029#", )), ));
...
fl$31[1]=(Ukddmlcoc_core.symbol.$_invoke$2(null, "p1__10029#", ));
...
// BEGIN mm-typed
dc.dynamic mm_typed(){
final dc.dynamic me$2=(Ukddmlcotm_core.make.$_invoke$6(const Ukddmlcoc_core.Keyword(null, "type", 3318123983, ), const Ukddmlcoc_core.Keyword("tiltontec.test.model-core", "typetest", 1623026163, ), const Ukddmlcoc_core.Keyword(null, "x2", 2899877263, ), (Ukddmlcotc_core.cI.$_invoke$1(2, )), const Ukddmlcoc_core.Keyword(null, "age", 1499655070, ), (Ukddmlcotc_core.make_c_formula.$_invoke$4(const Ukddmlcoc_core.Keyword(null, "value", 1949978408, ), Ukddmlcotc_base.unbound, const Ukddmlcoc_core.Keyword(null, "rule", 1345366267, ), (dc.dynamic slot_c$SHARP_$1, ){
final dc.dynamic me$1=Ukddmlcotc_base.c_model(slot_c$SHARP_$1, );
final dc.dynamic cell$1=slot_c$SHARP_$1;
final dc.dynamic slot_name$1=Ukddmlcotc_base.c_slot(slot_c$SHARP_$1, );
final dc.dynamic cache$1=Ukddmlcotc_base.c_value(slot_c$SHARP_$1, );
...
fl$3[2]=const Ukddmlcoc_core.Keyword("tiltontec.test.model-core", "typetest", 1623026163, );
final Ukddmlcoc_core.PersistentList $5=Ukddmlcoc_core.$_list_lit(fl$3, );

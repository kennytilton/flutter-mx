...
dc.dynamic iter$9916_$1(dc.dynamic coll$9917_$2, ){
dc.dynamic coll$9917_$1=coll$9917_$2;
do {
if(((coll$9917_$1!=false)&&(coll$9917_$1!=null))){
if(Ukddmlcoc_core.chunked_seq$QMARK_(coll$9917_$1, )){
final dc.dynamic c$7899_$AUTO_$2=Ukddmlcoc_core.chunk_first(coll$9917_$1, );
...
return iter$9916_$1(Ukddmlcoc_core.chunk_next(coll$9917_$1, ), );
} as dc.dynamic), null, -1, ), );
}
if(((exit$7901_$AUTO_$2!=false)&&(exit$7901_$AUTO_$2!=null))){
return null;
}
coll$9917_$1=Ukddmlcoc_core.chunk_next(coll$9917_$1, );
continue;
}
final dc.dynamic slot$4=Ukddmlcoc_core.first(coll$9917_$1, );
...
return iter$9916_$1(Ukddmlcoc_core.next(coll$9917_$1, ), );
} as dc.dynamic), null, -1, ), );
}
return null;
} while(true);

...
final Ukddmlcoc_core.Keyword result$8781_$AUTO_$1=const Ukddmlcoc_core.Keyword(null, "deferred-to-ufb-1", 749474456, );
...
result$8781_$AUTO_$2=((action$1 as Ukddmlcoc_core.IFn$iface).$_invoke$2(opcode$1, defer_info$1, ));
}else{
result$8781_$AUTO_$2=(Ukddmlcoc_core.IFn.extensions(action$1, ).$_invoke$2(action$1, opcode$1, defer_info$1, ));
}
...
final dc.dynamic vec$10170_$1=temp$7110_$AUTO_$2;
final dc.dynamic defer_info$1=(Ukddmlcoc_core.nth.$_invoke$3(vec$10170_$1, 0, null, ));
final dc.dynamic task_fn$1=(Ukddmlcoc_core.nth.$_invoke$3(vec$10170_$1, 1, null, ));
...
if(((temp$7110_$AUTO_$1!=false)&&(temp$7110_$AUTO_$1!=null))){
final dc.dynamic vec$10167_$1=temp$7110_$AUTO_$1;
final dc.dynamic defer_info$1=(Ukddmlcoc_core.nth.$_invoke$3(vec$10167_$1, 0, null, ));
final dc.dynamic task$1=(Ukddmlcoc_core.nth.$_invoke$3(vec$10167_$1, 1, null, ));
...
dc.dynamic iter$10164_$1(dc.dynamic coll$10165_$2, ){
dc.dynamic coll$10165_$1=coll$10165_$2;
do {
if(((coll$10165_$1!=false)&&(coll$10165_$1!=null))){
if(Ukddmlcoc_core.chunked_seq$QMARK_(coll$10165_$1, )){
final dc.dynamic c$7899_$AUTO_$2=Ukddmlcoc_core.chunk_first(coll$10165_$1, );
...
return iter$10164_$1(Ukddmlcoc_core.chunk_next(coll$10165_$1, ), );
} as dc.dynamic), null, -1, ), );
}
if(((exit$7901_$AUTO_$2!=false)&&(exit$7901_$AUTO_$2!=null))){
return null;
}
coll$10165_$1=Ukddmlcoc_core.chunk_next(coll$10165_$1, );
continue;
}
final dc.dynamic i$4=Ukddmlcoc_core.first(coll$10165_$1, );
...
return iter$10164_$1(Ukddmlcoc_core.next(coll$10165_$1, ), );
} as dc.dynamic), null, -1, ), );
}
return null;
} while(true);
...
dc.dynamic $_invoke$vararg(dc.dynamic $AMPERSAND_form$1, dc.dynamic $AMPERSAND_env$1, dc.dynamic p$10173_$1, dc.dynamic body$1, ){
final dc.dynamic vec$10175_$1=p$10173_$1;
final dc.dynamic opcode$1=(Ukddmlcoc_core.nth.$_invoke$3(vec$10175_$1, 0, null, ));
final dc.dynamic info$1=(Ukddmlcoc_core.nth.$_invoke$3(vec$10175_$1, 1, null, ));
